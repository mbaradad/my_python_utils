...
if __name__ == "__main__":
  parallel_delete('/data/vision/torralba/movies_sfm/home/no_training_cnn/contrastive_image_models/final_glsl_datasets/todelete_dos', max_level_to_parallelize=2)
