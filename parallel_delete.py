...
if __name__ == "__main__":
  parallel_delete('/data/vision/torralba/movies_sfm/home/no_training_cnn/contrastive_image_models/images_glsl_generated/stylegan2_generated_images', max_level_to_parallelize=3)
